...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    # Optional, but accepted and persisted — the OAuth signup path fills these in
    # from the provider, so a password signup that silently dropped them left
    # two different shapes of User depending on how the account was created.
