...
class CreditTransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'paystack_payment_reference', 'metadata', 'expiry_date', 'is_expired',
            'expired_at', 'is_expiring_soon', 'days_until_expiry'
        ]
...
class CreditPackageSerializer(serializers.ModelSerializer):
    ...
    effective_price = serializers.DecimalField(max_digits=10, decimal_places=2, read_only=True, source='get_effective_price')
    price_per_credit = serializers.DecimalField(max_digits=10, decimal_places=4, read_only=True, source='get_price_per_credit')
...
class CreditPackagePurchaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'billing_profile', 'package', 'package_details',
            'credits_purchased', 'amount_paid', 'currency', 'payment_method',
            'payment_reference', 'payment_provider', 'status', 'metadata',
            'purchased_at', 'completed_at', 'failed_at', 'refunded_at',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'user', 'billing_profile', 'credits_purchased', 'purchased_at',
            'completed_at', 'failed_at', 'refunded_at', 'created_at', 'updated_at'
        ]
...
class PromoCodeRedemptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'promo_code', 'promo_code_details', 'user',
            'plan', 'credit_package', 'original_amount',
            'discount_amount', 'final_amount', 'bonus_credits',
            'metadata', 'created_at'
        ]
...
class InvoiceLineItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'credit_package', 'plan', 'metadata', 'created_at'
        ]
...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = [
            'id', 'invoice_number', 'user', 'invoice_type', 'status',
            'invoice_date', 'due_date', 'paid_date', 'subtotal',
            'discount_amount', 'tax_amount', 'total_amount', 'amount_paid',
            'currency', 'payment_method', 'payment_reference',
            'customer_name', 'customer_email', 'customer_address',
            'notes', 'metadata', 'pdf_generated', 'line_items',
            'is_overdue', 'balance_due', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'invoice_number', 'user', 'pdf_generated',
            'created_at', 'updated_at'
        ]
